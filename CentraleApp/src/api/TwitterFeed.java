...
/**
 * Class for aggregating Twitter data. Uses Twitter's Search API using App
 * authentication.
 *
 * @author Etienne
 */
public class TwitterFeed {
    ...
    /**
     * The URL for requesting data about the amount of requests left for the
     * current timeframe.
     */
    private static final String RATE_LIMIT_STATUS = "https://api.twitter.com/1.1/application/rate_limit_status.json";

    /**
     * The URL for requesting data about a specific search. Basic URL for query
    ...
    /**
     * Returns tweets based on their GPS coordinates. Currently being debugged
     * (23-03)
     *
     * @param latitude
     * @param longitude
    ...
    /**
     * Encodes the consumer key and secret to create the basic authorization
     * key. Used for authorizing for the Twitter API.
     *
     ...
     * token as a string. Used for authorizing for the Twitter API.
     *
